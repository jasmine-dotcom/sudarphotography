...
export default function Portfolio() {
  ...
  const handleWhatsApp = (packageName: string) => {
    const message = encodeURIComponent(
      `Hi Sudar Photography, I would like to enquire about the ${packageName}. Please share more details.`,
    );
        ...
        <div className="section-shell">
          <div className="mb-12 max-w-3xl">
            ...
            <p className="mt-5 text-sm leading-7 text-white/62 sm:text-base">
              Choose from four curated Sudar Photography wedding packages, each presented with the
